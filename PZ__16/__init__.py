...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.column('add_FIO', width=170, anchor=tk.CENTER)
        self.tree.column('product', width=80, anchor=tk.CENTER)
        self.tree.column('measurement', width=50, anchor=tk.CENTER)
        self.tree.column('quantity', width=100, anchor=tk.CENTER)
        self.tree.column('price', width=100, anchor=tk.CENTER)
        self.tree.column('nagr', width=100, anchor=tk.CENTER)
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.combobox2 = ttk.Combobox(self, values=[u'Да', u'Нет'])
        self.combobox2.current(0)
        self.combobox2.place(x=230, y=200)
